...
<blockquote>
Unit tests are designed to check the logic of your function and no more.
</blockquote>
...
it('should exist', function() {
  assert.equal(typeof ctrl.postNote, 'function');
});

it('should run the query', function() {
  ctrl.postNote(req, res, db);
...
describe('controller', function() {
  describe('postNote()', function() {
    ...
    // TEST CASES
    it('should exist', function() {
      assert.equal(typeof controller.postNote, 'function');
    });

    it('should run the query', function() {
      controller.postNote(req, res, db);
      assert.equal(ran, true);
    });
